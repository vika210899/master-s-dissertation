...
class Constants:
    ...
    CONSOLE_WRITER_FILE_NAME = "console_output_" + str(COUNT_OF_TRAINING_REPEAT) + "_" + str(COUNT_OF_MOST_COMMON_WORDS) + "_" + str(EXCEL_RANGE) + ".txt"
    SAVE_FILE = "trainready_" + str(COUNT_OF_TRAINING_REPEAT) + "_" + str(COUNT_OF_MOST_COMMON_WORDS) + "_" + str(EXCEL_RANGE) + ".antondahann"